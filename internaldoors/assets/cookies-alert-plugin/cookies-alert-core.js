(function (c) {
    ...
    var f = function (a) {
        ...
        h = function (a, c, b) {
            var e = "";
            b && (e = new Date, e.setTime(e.getTime() + 864E5 * b), e = "; expires=" + e.toGMTString());
        ...
        l = function (a) {
            ...
            if (a.cookieScripts) {
                ...
                if (1 < b) {
                    ...
                    d = " We use " + e.substring(0, e.length - 2) + " and " + d[b - 1] + " scripts, which all set cookies. "
                } else d = " We use a " + d[0] + " script which sets cookies."
            }
            b = '<div id="epd">' + ('<div id="cookiesdirective" style="position:' +
                a.css + ";" + a.position + ":-300px;left:0px;width:100%;");
            b += "height:auto;background:" + a.backgroundColor + ";opacity:." + a.backgroundOpacity + ";";
            b += "-ms-filter: \u201calpha(opacity=" + a.backgroundOpacity + ")\u201d; filter: alpha(opacity=" + a.backgroundOpacity + ");";
            b += "-khtml-opacity: ." + a.backgroundOpacity + "; -moz-opacity: ." + a.backgroundOpacity + ";";
            b += "color:" + a.fontColor + ";font-family:" + a.fontFamily + ";font-size:" + a.fontSize + ";letter-spacing: 0;";
            b += 'text-align:center;z-index:1000;">';
            b += '<div class="cookieText" style="position:relative;height:auto;width:90%;padding:10px;margin-left:auto;margin-right:auto;">';
            ...
            c("#cookiesdirective").animate(d, 1E3, function () {
                a.explicitConsent ? c("#explicitsubmit").click(function () {
                    c("#epdagree").is(":checked") ? (h("cookiesDirective", 1, 365), c("#cookiesdirective").animate(k, 1E3, function () {
